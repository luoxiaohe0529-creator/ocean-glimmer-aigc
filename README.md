...
| 模型路由 | KIE Gemini 3.1 Pro、DeepSeek及图像/视频模型按阶段与语言分工 |
...
| 文本与多模态模型 | KIE Gemini 3.1 Pro、DeepSeek | Gemini 负责 Stage 1 产品简报、创意方案、Mood Board、Hook、中文脚本和摄影分镜；英文脚本使用 DeepSeek |
