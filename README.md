...
**大海浮光 AIGC 工作台**是一款面向电商与品牌内容团队的 AI 广告生产产品。产品设计了四个专业 Agent：广告策划 Agent 负责产品分析与创意方案，编剧导演 Agent 负责脚本与导演分镜，摄影摄像 Agent 负责角色、分镜图与视频生成，后期剪辑 Agent 负责剪辑、配乐、字幕、画质增强和高清交付。用户决定创意方向，四个 Agent 接力完成制作。

操作上，用户只需导入商品链接、产品文档或图片，无需编写专业提示词，也无需切换多个 AI 软件。系统先提供**产品简报、3 套创意方案、3 组 Mood Board 和 12 条 Hook**供用户选择；确认方向后，后续脚本、分镜、影像和后期任务自动执行，并持续显示进度与回写结果。

传统实拍信息流广告需要协调策划、编导、演员、场地、拍摄和后期，方向调整还可能产生补拍与重剪。大海浮光将多人串行制作转化为**用户选择方向、四个 Agent 自动接力**的工作流，减少人员、拍摄、沟通和返工成本，缩短从创意到成片的制作周期；单条带货视频生成成本**实测低至人民币个位数**。
...
<td align="center" valign="top"><strong>华为品牌信息流广告（中文） · 成片 02</strong><br><video src="https://github.com/user-attachments/assets/4d72ad2e-7dac-4bd3-934c-a7f3425c5a8c" poster="https://luoxiaohe0529-creator.github.io/ocean-glimmer-aigc/media/video-02-product.png" controls preload="metadata" width="260"></video></td>第 02 条封面单独用这张图片：

  <img
    src="https://luoxiaohe0529-creator.github.io/ocean-glimmer-aigc/media/video-
    02-product.png"
    width="260"
    alt="华为品牌信息流广告（中文）· 成片 02 封面">
...
<td align="center" valign="top">
  ...
  <video
    src="https://luoxiaohe0529-creator.github.io/ocean-glimmer-aigc/media/
    huawei-feed-ad-06.mp4"
    controls
    preload="metadata"
    width="260">
  </video>
...
```mermaid
flowchart LR
  A["商品链接 / 产品文档 / 图片"] --> B["广告策划 Agent<br/>产品简报 · 创意方案 · Mood Board · Hook"]
  B --> C{"用户确认创意方向"}
  C --> D["编剧导演 Agent<br/>完整脚本 · 导演分镜"]
  D --> E["摄影摄像 Agent<br/>角色形象 · 分镜参考 · 视频生成"]
  E --> F["后期工作台<br/>配乐 · 字幕 · 画质增强"]
  F --> G["最终成片"]
```
