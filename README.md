...
**大海浮光 AIGC 工作台**是一款能提供完整的 AI 广告生产流程的、面向电商与品牌内容团队的 AIGC 产品。系统内设计了四个专业 Agent，分别负责广告策划、编剧导演、摄影摄像和后期剪辑。其中，每个角色都配备了知识库，作为高级智囊团。用户在 Agent 生成创意方向后，只需选择与把控创意方向，就能生成复合要求的的 AIGC 视频。
