...
<td align="center" valign="top"><strong>华为品牌信息流广告（中文） · 成片 02</strong><br><video src="https://github.com/user-attachments/assets/4d72ad2e-7dac-4bd3-934c-a7f3425c5a8c" poster="https://github.com/user-attachments/assets/5307af83-3bb4-422e-84e2-324d2d95a9d4" controls preload="metadata" width="260" height="462"></video></td>
...
广告策划 Agent 一次生成 **12 条 Hook（每条hook都有创意方案、Mood Board ）。供用户比较并确认方向后，所选方案继续传递给脚本、分镜和视频生成阶段。
