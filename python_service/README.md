...
Configuration is read from the project `.env`. Runtime stages never use local content templates: they require their configured model and the matching live Feishu Wiki.
